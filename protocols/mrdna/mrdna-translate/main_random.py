...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--box", type=float, default=150., help='Length of cubic box')
    parser.add_argument("-n", "--number", type=int, default=4, help='Number of replicas')
    #parser.add_argument("-ns", "--n_strands", type=int, default=8, help='Number of strands within one strand (defines number of turns)')
    parser.add_argument("-l", "--overall_length", type=int, nargs=3, default=[150, 50, 200], help='Number of strands within one strand (defines number of turns)')
    #parser.add_argument("-l", "--length", type=int, default=16, help='Length of a single-stranded portion in between turns')
    parser.add_argument("-p", "--percent_stapled", type=int, nargs=3, default=[40, 20, 60], help='Length of a single-stranded portion in between turns')
    #parser.add_argument("-s", "--stapled", type=int, default=5, help='Length of double-stranded portion')
    parser.add_argument("-ds", "--length_stapled", type=int, nargs=3, default=[20, 5, 25], help='Length of double-stranded portion')
